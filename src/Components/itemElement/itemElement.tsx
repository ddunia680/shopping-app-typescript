  ...
  return (
    ...
    flex-col justify-evenly items-start rounded-xl duration-150 hover:duration-150'>
        ...
        <div className='bg-transparent w-[90%] h-[75%] rounded-xl relative'>
            ...
            <BsBalloonHeartFill size={40} className='absolute top-[-1rem] right-2 bg-white text-red-700 rounded-full shadow-sm shadow-red-700 
            p-1 hover:scale-125 hover:duration-150 duration-150' title='Add To Wish List?' onClick={() => addToWishList()}/>
        </div>
        <div className=''>
            <p>{price}</p>
