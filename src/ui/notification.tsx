...
export default function Notification() {
  ...
  return (
    <motion.div 
      ...
      <h2 className="font-semibold text-[15px] md:text-[17px]">Notification</h2>
      <p className="text-[12px] text-gray-600 font-thin flex justify-start items-center gap-1">{ isError && <TiWarning size={25} className='text-red-600' />}{notificationText}</p>
    </motion.div>
  )
}
